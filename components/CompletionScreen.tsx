...
const CompletionScreen: React.FC<CompletionScreenProps> = ({ onReset, feedback, feedbackTranslation, isLoading }) => {
  return (
    <div className="flex flex-col items-center justify-center h-full p-4 text-center">
      <div className="max-w-xl w-full bg-gray-800/50 p-8 rounded-xl shadow-2xl border border-gray-700">
        <h2 className="text-3xl font-bold mb-4 text-green-400">Hoàn Thành Hội Thoại!</h2>
                ...
                <>
                    ...
                    {feedbackTranslation && (
                        <div className="mt-4 pt-4 border-t border-gray-600">
                            <p className="text-teal-400 text-sm italic whitespace-pre-wrap">{feedbackTranslation}</p>
                        </div>
                    )}
                </>
            )}
